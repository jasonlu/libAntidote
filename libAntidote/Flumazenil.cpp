...
namespace libAntidote {
    ...
    Flumazenil::Flumazenil(double age, double height, double weight) : Antidote(age, height, weight) {
        ...
        string flumWarning = string("If a patient has not responded 5 minutes after receiving a cumulative maximum dose ") +
    ...
    string Flumazenil::getRef() {
        return string("Westward Pharmaceuticals. (2011, July 1). Flumazenil Injection, USP. Package Insert.\n") +
