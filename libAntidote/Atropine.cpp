...
namespace libAntidote {
    ...
    Atropine::Atropine(double age, double height, double weight) : Antidote(age, height, weight) {
        ...
        b = "For the treatement of organophosphorus and \n N-methyl carbamate insecticides\n",
        c = "\n(Hospira, Inc. , 2009)",
        ...
        "antidote for organophosporous or muscarinic mushroom poisoning. When used as an antidote, the 2 to3 mg\n" +
        ...
        string stringAutoAdult = string("If using the atropine auto-injector, the dosage is based on weight as follows: if\n)") +
    ...
    string Atropine::getRef() {
        return string("References for Atropine Algorithm\n\n") +
        "Hospira, Inc. . (2009, November 1). Atropine Sulfate . Atropine Sulfate Package Insert.\n" +
        "Lake Forest, Illinois, U.S.: Hospira, Inc.\n\n" +
        "Meridian Medical TechnologiesTM, Inc. (2005, November 1). ATROPEN AUTO-INJECTOR - atropine\n" +
        "sulfate injection Package Insert. Columbia, Maryland, U.S. Meridian Medical TechnologiesTM,\n" +
        "Inc.\n\n";
    }
